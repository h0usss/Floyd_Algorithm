...
public class AlgorithmTests {
    ...
    public void testAlgorithmFindShortestPath() {
        ...
        FloydMatrix ex = new FloydMatrix(outW, outO);
        ArrayList<Integer> rez = Algorithm.findShortestPath(1, 7, ex);
        ArrayList<Integer> ans = new ArrayList<>(Arrays.asList(11, 1, 3, 2, 6, 7));
        assertEquals(ans, rez);
    }
...
//        ArrayList<Integer> rez = Algorithm.findShortestPath(1, 5, ex);
//        ArrayList<Integer> ans = new ArrayList<>(Arrays.asList(11, 1, 3, 2, 6, 7));
//        assertEquals(ans, rez);
    }
}
